                    ...
                    <div class="col-3">
                        ...
                        <div class="card text-center border-dark mb-3">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">Manuel</li>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">Miranda</li>
                            </ul>
                            <h5 class="card-title">
                                Correo electrónico
                            </h5>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">mnlmiranda04@outlook.com</li>
                            </ul>
                            <button type="button" class="btn btn-outline-primary mt-3 mb-3" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">Editar cuenta
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control" id="fltInputPassword" placeholder="Password">
